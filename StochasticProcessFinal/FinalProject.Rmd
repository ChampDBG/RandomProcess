...
期望若有學弟妹想要做相關的 final project，可以使用其他的方法來判斷是否為常態分布。

# 五、心得
從大一以來就一直聽聞中央極限定理的神奇事蹟，但也就停留在最基本的認識，很開心透過這次的 Final Project 能與這位認識已久的朋友，有更深入的認識。若學弟妹有需要，還請老師將這份報告分享給他們，感謝老師這學期的指導。
